...
<?php 
    ...
    <section>
        <div class="container-md">
            <div class="mt-4 mb-4">
                <h3><p>Раздел "Отходы"</p></h3>
                <p class="fst-italic">Здесь представлен список отходов, возникающих из-за различных видов детельности. </p>
                <p class="fst-italic">Вы можете занести новые отходы от деятельности либо изменить уже существующие.</p>
                <hr>
            </div>
            <div class="mt-4 mb-4">
                <div class="row">
