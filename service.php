...
<head>
    ...
    <title>Акты об оказании услуг</title>
</head>
<body>
...
<?php 
    ...
    <section>
        <div class="container-md">
            <div class="mt-4 mb-4">
                <h3><p>Акты об оказании услуг</p></h3>
                <p class="fst-italic">Здесь представлены все акты об оказании услуг нашим клиентам. </p>
                <p class="fst-italic">Вы можете добавить новый акт в список, либо ознакомиться и отредактировать уже существующий.</p>
                <hr>
            </div>
            <div class="mt-4 mb-4">
                <div class="row">
                    <div class="col-md-5 mb-4">
                        <a data-bs-toggle="modal" data-bs-target="#exampleModal"><button class="btn btn-primary">Добавить новый акт</button></a>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Новый акт</h5>
